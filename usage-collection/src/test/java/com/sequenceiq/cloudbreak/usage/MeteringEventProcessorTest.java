...
public class MeteringEventProcessorTest {
    ...
    public void testProcessEvent() {
        ...
        MeteringEventsProto.MeteringEvent event = MeteringEventsProto.MeteringEvent.newBuilder().build();
        underTest.processEvent(event);
        ...
        assertEquals(event, captor.getValue().getMessageBody().get());
