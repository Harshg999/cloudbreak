...
public class RedbeamsUpgradeServiceTest {
    ...
    private static final String TARGET_MAJOR_VERSION = "targetMajorVersion";
    ...
    void testUpgradeDatabaseServerWhenAvailable() {
        ...
        underTest.upgradeDatabaseServer(SERVER_CRN_STRING, TARGET_MAJOR_VERSION);
        ...
        assertEquals(TARGET_MAJOR_VERSION, redbeamsStartUpgradeRequest.getMajorVersion());
    }
