...
public class RedbeamsUpgradeActions {
    ...
    public Action<?, ?> backupDatabaseServer() {
        return new AbstractRedbeamsUpgradeAction<>(RedbeamsStartUpgradeRequest.class) {
            ...
            @Override
            protected void prepareExecution(RedbeamsStartUpgradeRequest payload, Map<Object, Object> variables) {
                variables.put(TARGET_MAJOR_VERSION, payload.getMajorVersion());
            ...
            protected Selectable createRequest(RedbeamsContext context) {
                return new BackupDatabaseServerRequest(
    ...
    public Action<?, ?> upgradeDatabaseServer() {
        return new AbstractRedbeamsUpgradeAction<>(BackupDatabaseServerSuccess.class) {
            ...
            protected void doExecute(RedbeamsContext context, BackupDatabaseServerSuccess payload, Map<Object, Object> variables) {
                String targetMajorVersion = (String) variables.get(TARGET_MAJOR_VERSION);
                sendEvent(context,
    ...
    public Action<?, ?> upgradeFinished() {
        return new AbstractRedbeamsUpgradeAction<>(RestoreDatabaseServerSuccess.class) {
            ...
            @Override
            protected Selectable createRequest(RedbeamsContext context) {
                return new RedbeamsEvent(RedbeamsUpgradeEvent.REDBEAMS_UPGRADE_FINISHED_EVENT.name(), 0L);
            }
        };
    }
    ...
    public Action<?, ?> upgradeFailed() {
        return new AbstractRedbeamsUpgradeAction<>(RedbeamsUpgradeFailedEvent.class) {
            ...
            @Override
            protected Selectable createRequest(RedbeamsContext context) {
                return new RedbeamsEvent(RedbeamsUpgradeEvent.REDBEAMS_UPGRADE_FAILURE_HANDLED_EVENT.event(), 0L);
            }
        };
    }
